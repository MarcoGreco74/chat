...
<body class="text-center" style="background-color:#a2a6aa;">  
<main class="form-signin w-50 m-auto">
<form method="post" action="fileLogin.php">   
    <img class="mb-4" src="chat.png" width="72" height="57">
    ...
    <p>Not a member? <a href="fileRegister.php" name='register'>Register</a></p>
